...
OBJECTS       = harbour-age_calculator.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-age_calculator.pro \
		harbour-age_calculator.pro
QMAKE_TARGET  = harbour-age_calculator
...
Makefile: harbour-age_calculator.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/harbour-age_calculator1.0.0 || mkdir -p .tmp/harbour-age_calculator1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/harbour-age_calculator1.0.0/ && $(COPY_FILE) --parents src/harbour-age_calculator.cpp .tmp/harbour-age_calculator1.0.0/ && (cd `dirname .tmp/harbour-age_calculator1.0.0` && $(TAR) harbour-age_calculator1.0.0.tar harbour-age_calculator1.0.0 && $(COMPRESS) harbour-age_calculator1.0.0.tar) && $(MOVE) `dirname .tmp/harbour-age_calculator1.0.0`/harbour-age_calculator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/harbour-age_calculator1.0.0
...
harbour-age_calculator.o: src/harbour-age_calculator.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o harbour-age_calculator.o src/harbour-age_calculator.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-age_calculator || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-age_calculator
	-$(INSTALL_DIR) /home/mersdk/QtProjects/harbour-age_calculator/qml $(INSTALL_ROOT)/usr/share/harbour-age_calculator/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-age_calculator/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-age_calculator/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/QtProjects/harbour-age_calculator/harbour-age_calculator.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/harbour-age_calculator.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-age_calculator.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/QtProjects/harbour-age_calculator/harbour-age_calculator.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-age_calculator.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-age_calculator.png
